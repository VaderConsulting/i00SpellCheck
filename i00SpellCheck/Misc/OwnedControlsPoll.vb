...
#End Region
    ...
    Private Sub CheckNewForms(ByVal state As Object)
        Dim AllOwnedForms()() As Form = Nothing

        SyncLock ControlPolls
            Try ' Edit 27 June 2013 DR
                AllOwnedForms = (From xItem In ControlPolls.OfType(Of Form)() Select xItem.OwnedForms).ToArray
            Catch ex As Exception ' Edit 27 June 2013 DR
            End Try ' Edit 27 June 2013 DR
        End SyncLock

        Dim NewForms As New List(Of Form)
        Try ' Edit 30 June 2013 DR
            For Each iForms In AllOwnedForms
                ...
                Next
            Next
        Catch ex As Exception ' Edit 30 June 2013 DR
        End Try ' Edit 30 June 2013 DR
